...
export default function Completed() {
    ...
    return (
      <div>
        <div className="mb-8 md:mb-10">
          <h1 className="text-h1 font-display font-bold text-vault-text tracking-tight">Completed</h1>
          <p className="text-body-sm text-vault-muted mt-1">0 titles completed</p>
        </div>
        <EmptyState
  ...
  return (
    <div>
      <div className="mb-8 md:mb-10">
        <h1 className="text-h1 font-display font-bold text-vault-text tracking-tight">Completed</h1>
        <p className="text-body-sm text-vault-muted mt-1">{completed.length} titles completed</p>
      </div>
      <FilterBar
